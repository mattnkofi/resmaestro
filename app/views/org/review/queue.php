...
<body class="bg-maestro-bg text-white font-poppins" x-data="{}">
    ...
    <div class="ml-64 p-8 bg-maestro-bg min-h-screen text-white">
        ...
        <div class="flex flex-col md:flex-row gap-4 mb-8">
            <input type="text" placeholder="Search by document title or submitter..." 
            ...
            <select class="w-full md:w-1/6 bg-yellow-900/50 border border-yellow-800 p-3 rounded-xl text-white">
        ...
        <div class="overflow-x-auto rounded-xl border border-green-800 shadow-2xl shadow-green-900/10">
            <table class="w-full text-left">
                ...
                <tbody class="bg-[#0f1511] text-gray-300">
                    ...
                    $review_queue = [
                        ['title' => 'Policy Draft V3', 'submitter' => 'Jerome De Lizo', 'date' => 'Nov 1, 2025', 'days' => 0],
                        ['title' => 'Q4 Budget Report', 'submitter' => 'Ellaine Cordero', 'date' => 'Oct 30, 2025', 'days' => 2],
                        ['title' => 'Vendor Contract V2.1', 'submitter' => 'John Smith', 'date' => 'Oct 28, 2025', 'days' => 4],
                        ['title' => 'Holiday Policy Draft', 'submitter' => 'Jane Doe', 'date' => 'Oct 20, 2025', 'days' => 12], // Overdue
                    ];
                    ...
                    <tr class="border-b border-green-800 transition <?= $row_class ?>">
                        ...
                        <td class="p-4 text-center">
                            <a href="<?=BASE_URL?>/org/review/<?= urlencode($doc['title']) ?>" class="bg-yellow-700 hover:bg-yellow-600 px-4 py-2 rounded-lg text-sm font-semibold transition shadow-md shadow-yellow-900/30">
