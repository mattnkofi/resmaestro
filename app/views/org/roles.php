...
<head>
    ...
    <title>Roles & Permissions - Maestro UI</title>
...
<body class="bg-maestro-bg text-white font-poppins" x-data="{}">
    ...
    <div class="ml-64 p-8 bg-maestro-bg min-h-screen text-white">
        ...
        <!-- Main Grid: Roles List (2/3) + Permissions Matrix (1/3) -->
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">

            <!-- Left Column: Roles List (2/3 width) -->
            <div class="lg:col-span-2 space-y-4">
                <?php
                // Mock data for the roles list
                $roles = [
                    ['name' => 'Administrator', 'description' => 'Full control over users, documents, and settings.', 'access' => 'Full Access', 'color' => 'red'],
                    ['name' => 'Reviewer', 'description' => 'Can review, comment on, approve, and reject documents.', 'access' => 'Can review and comment', 'color' => 'yellow'],
                    ['name' => 'Secretary', 'description' => 'Document uploading, management, and basic member creation.', 'access' => 'Upload & Manage', 'color' => 'blue'],
                    ['name' => 'Standard Member', 'description' => 'Can view and download approved documents only.', 'access' => 'Read-Only', 'color' => 'gray'],
                ];
            ...
            <!-- Right Column: Permissions Matrix Detail (1/3 width) -->
